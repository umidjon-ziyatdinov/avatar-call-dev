...
: <p className='text-center'>Avatar Not found</p>
      ...
      >
        <Card className="p-2 space-y-6  w-full sm:border-none">

          
          {/* Header Section with Image Upload */}
          <div className="flex flex-col sm:flex-row gap-6">
            <div className="w-full sm:w-1/3 space-y-4">
              <div className="relative mx-auto sm:flex sm:flex-col sm:justify-center  sm:items-center">
                <img
                  src={avatarPreview || "/images/default-profile.png"}
                  alt="Avatar preview"
                  className="w-40 h-40 sm:size-60 rounded-lg object-cover border-2 border-gray-200 dark:border-gray-700 mx-auto sm:mx-0"
                />
                {avatarPreview && !avatar && (
                  <button
                    type="button"
                    onClick={() => {setAvatarPreview(null); setAvatarFile(null)}}
                    className="absolute -top-2 sm:-top-0 -right-2 bg-red-500 text-white rounded-full p-1.5 hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                  >
...
<div className="flex justify-center w-full">
  <SubmitButton 
    className="min-w-[150px] sx:mx-w-[500px] sm:min-w-[350px] w-full sm:w-auto sm:h-[60px]" 
    isLoading={isLoading} 
