...
export default function AvatarAdminPage({user}: {user:{id: string, role:string}}) {
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
          ...
          <DialogContent className=" h-svh sm:max-h-[90vh] overflow-y-auto sm:max-w-[1000px] px-0">
            ...
            <AvatarForm onClose={() => {setIsCreateOpen(false); mutate()}} createEndpoint="/api/avatar?public=true" userRole={user.role} />
          </DialogContent>
        </Dialog>
      </div>
